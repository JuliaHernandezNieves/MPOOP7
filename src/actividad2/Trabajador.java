 ...
 */
    public Trabajador(float salario, int horaEntrada, int horaSalida, Mascota mascota, String nombre, int edad) {
...
/**
 * Metodo que muestra los datos de un Trabajador
 * @return salario, horaEntrada, horaSalida, mascota, nombre, edad y metodo de un Trabajador
 */
    ...
    public String toString() {
        return "Trabajador{" + "salario=" + salario + ", horaEntrada=" + horaEntrada + ", horaSalida=" + horaSalida + '}';
    }
