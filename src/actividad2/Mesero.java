...
/**
 * Metodo que muestra los datos de un Mesero
 * @return resturant, numero de mesas, colorDelUniforme, salario, hora de entrada, hora de salida, mascota, nombre, edad y metodos de un Mesero 
 */
    ...
    public String toString() {
        return "Mesero{" + "restaurante=" + restaurante + ", numMesas=" + numMesas + ", colorDelUniforme=" + colorDelUniforme + '}';
    }
