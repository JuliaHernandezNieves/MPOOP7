 ...
 */
    public ProfesorCarrera(String asignatura, int grupo, int numAlumnos, float salario, int horaEntrada, int horaSalida, Mascota mascota, String nombre, int edad) {
...
/**
 * Metodo que muestra los datos de un ProfesorCarrera
 * @return asignatura, grupo, numAlumnos, salario, hora de entrada, hora de salida, mascota, nombre, edad y metoos de un ProfesorCarrera
 */
 ...
 */
    ...
    public String toString() {
        return "ProfesorCarrera{" + "asignatura=" + asignatura + ", grupo=" + grupo + '}';
    }
