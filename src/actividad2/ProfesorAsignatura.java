...
/**
 * Metodo que muestra los datos de un ProfesorAsignatura
 * @return nombreAsignatura, numAlumnos, salario, horaEntrada, horaSalida, mascota, nombre, edad y metoos de un ProfesorAsignatura 
 */
    ...
    public String toString() {
        return "ProfesorAsignatura{" + "nombreAsignatura=" + nombreAsignatura + '}';
    }
